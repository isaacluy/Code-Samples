...
?>
	<div id="middle">
		<div id="content" class="container_16">
			...
			<h2 class="grey_line">Formulario de pedidos</h2>
			<div id="formulario">
				<?php
				...
				?>
				<p>A trav&eacute;s del siguiente formulario usted se puede poner en contacto directo con el Fondo Global de Alimentos para pedir informaci&oacute;n sobre cualquiera de los productos que manejamos.</p>
				<form id="pedidoForm" action="pedido.php" method="post" accept-charset="utf-8">
					...
					<div class="grid_6">
						...
						<select name="producto" id="producto_granos" class="hide">
							<option value="maiz"<?php if($p == "maiz"){ echo ' selected="selected"';}?>>Ma&iacute;z</option>
							<option value="trigo"<?php if($p == "trigo"){ echo ' selected="selected"';}?>>Trigo</option>
							<option value="cebada"<?php if($p == "cebada"){ echo ' selected="selected"';}?>>Cebada</option>
							<option value="sorgo"<?php if($p == "sorgo"){ echo ' selected="selected"';}?>>Sorgo</option>
							<option value="cafe"<?php if($p == "cafe"){ echo ' selected="selected"';}?>>Caf&eacute;</option>
							<option value="cafe_organico"<?php if($p == "cafe_organico"){ echo ' selected="selected"';}?>>Caf&eacute; Org&aacute;nico&nbsp;</option>
						</select>
						<select name="producto" id="producto_animales" class="hide">
							<option value="aves"<?php if($p == "aves"){ echo ' selected="selected"';}?>>Aves de corral</option>
							<option value="bovino"<?php if($p == "bovino"){ echo ' selected="selected"';}?>>Ganado bovino</option>
							<option value="porcino"<?php if($p == "porcino"){ echo ' selected="selected"';}?>>Ganado porcino&nbsp;</option>
						</select>
						<select name="producto" id="producto_aceites" class="hide">
							<option value="aceite_maiz"<?php if($p == "aceite_maiz"){ echo ' selected="selected"';}?>>Aceite de ma&iacute;z</option>
							<option value="aceite_girasol"<?php if($p == "aceite_girasol"){ echo ' selected="selected"';}?>>Aceite de girasol</option>
							<option value="aceite_oliva"<?php if($p == "aceite_oliva"){ echo ' selected="selected"';}?>>Aceite de oliva</option>
							<option value="aceite_soya"<?php if($p == "aceite_soya"){ echo ' selected="selected"';}?>>Aceite de soya</option>
							<option value="aceite_pescado"<?php if($p == "aceite_pescado"){ echo ' selected="selected"';}?>>Aceite de pescado</option>
							<option value="azucar"<?php if($p == "azucar"){ echo ' selected="selected"';}?>>Az&uacute;car</option>
							<option value="azucar_organica"<?php if($p == "azucar_organica"){ echo ' selected="selected"';}?>>Az&uacute;car Org&aacute;nica&nbsp;</option>
						</select>
						...
						<select name="puerto_salida" id="puerto_salida">
							<option value="" selected="selected">Seleccione el puerto de embarque &nbsp;</option>
						...
						<select name="puerto_llegada" id="puerto_llegada">
							<option value="" selected="selected">Seleccione el puerto de destino&nbsp;</option>
							<option value="usa"><?php echo $pageDescriptions["usa"];?></option>
							<option value="venezuela"><?php echo $pageDescriptions["venezuela"];?></option>
							<option value="brasil"><?php echo $pageDescriptions["brasil"];?></option>
							<option value="argentina"><?php echo $pageDescriptions["argentina"];?></option>
